...
delivered_table_spec = 'consummate-yew-336502:dataset_food_orders_latest.delivered_orders'
#project-id:dataset_id.table_id
other_table_spec = 'consummate-yew-336502:dataset_food_orders.other_status_orders'
...
def create_view():
    ...
    view_to_create.view_query = 'select * from `consummate-yew-336502.dataset_food_orders.delivered_orders` where _PARTITIONDATE = DATE(current_date())'
